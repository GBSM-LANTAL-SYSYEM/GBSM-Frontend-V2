          ...
          <S.Parent>
                  ...
                  <div>
                    ...
                    <S.NoticeRuleCont>
                      ...
                      <p className="explanation">
                        미리 안 열어놓고 야자시간에 열쇠달라고 해도 안 열어줌,
                        손으로 따다 적발 시 벌점 20점
                      </p>
                    </S.NoticeRuleCont>
                    <S.NoticeRuleCont>
                      <p className="notice_text">
                        실습실 사용 후 정리는 매너이자 필수 !
                      </p>
                      <p className="explanation">
                        전원, 냉난방, 조명, 책상 의자 배치 등 정리 / 지켜지지
                        않을 시 2주간 실습실 이용 제한
                      </p>
                    </S.NoticeRuleCont>
                  </div>
            ...
            <S.StudentHeader>
              ...
              <div>
                ...
                <button onClick={fetchAvailableLabs} disabled={isLoading}>
                  조회
                </button>
              </div>
            </S.StudentHeader>
                ...
                {isLoading ? (
                  ...
                  sortedRequests.map((request) => (
                    <S.RentalUserWrap key={request.userId}>
                      ...
                      <C.Tooltip
                        text={request.rentalUsers}
                        maxLength={12}
                        className="user_detail"
                      />
                      <C.Tooltip
                        text={request.rentalPurpose}
                        maxLength={16}
                        className="user_detail"
                      />
                  ...
                  <S.NotRentTextWrap>
                    <S.CharacterWrap>
                      <img
                        src={MeisterCharacter}
                        alt=""
                        className="meister_character"
                      />
